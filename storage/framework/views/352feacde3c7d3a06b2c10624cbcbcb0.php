...
<?php ($pageTitle = 'Destinations | Aurelia Travel'); ?>
...
<section class="hero-shell" style="min-height:78vh;">
  <div class="hero-bg active" style="background-image:url('<?php echo e(asset('assets/desa.jpg')); ?>'); opacity:1"></div>
        ...
        <article class="destination-card reveal" data-item="<?= e($destinationCategories[$dest['name']] ?? 'city') ?>" data-search="<?= e($dest['name'] . ' ' . $dest['country'] . ' ' . $dest['tag']) ?>">
          ...
          <div class="destination-content">
            ...
            <div class="d-flex flex-wrap gap-2">
              ...
              <a class="btn btn-gold" href="<?= e(route('booking.create')) ?>">Book a trip</a>
            </div>
          </div>
        </article>
      <?php endforeach; ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\faim\laravel-final-project\aurelia_laravel\resources\views/home/destinations.blade.php ENDPATH**/ ?>