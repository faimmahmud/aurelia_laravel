  ...
  <section class="home-section home-section--luxury-destinations">
    <div class="container">
      <div class="luxury-section-head reveal">
        ...
        <a class="home-link" href="<?= e(route('destinations')) ?>">View all destinations <i class="bi bi-arrow-right"></i></a>
      </div>
      ...
      <div class="luxury-destination-grid">
        ...
        <aside class="luxury-offer-card reveal">
          ...
          <a class="btn btn-light rounded-pill px-4 fw-semibold luxury-offer-card__cta" href="<?= e(route('packages')) ?>">Explore Deals <i class="bi bi-arrow-right ms-1"></i></a>
        </aside>
      </div>
    </div>
  </section>
      ...
      <article class="featured-journey reveal" style="background-image:url('<?= e(asset('assets/world.jpg')) ?>')">
        ...
        <div class="featured-journey__body">
          ...
          <div class="featured-journey__price-row">
            ...
            <a href="<?= e(route('booking.create')) ?>" class="btn btn-primary rounded-pill px-4 fw-semibold">Explore Journey <i class="bi bi-arrow-right ms-1"></i></a>
          </div>
        </div>
  ...
  <section class="home-section">
    <div class="container">
      <div class="d-flex align-items-end justify-content-between gap-3 mb-4 flex-wrap">
        ...
        <a class="home-link reveal" href="<?= e(route('packages')) ?>">View all packages <i class="bi bi-arrow-right"></i></a>
      </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\faim\laravel-final-project\aurelia_laravel\resources\views/home/index.blade.php ENDPATH**/ ?>