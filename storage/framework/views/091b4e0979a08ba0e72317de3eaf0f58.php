...
<?php ($pageTitle = 'Booking | ' . ($site['brand'] ?? 'Aurelia Travel')); ?>

<?php $__env->startSection('content'); ?>
<section class="hero-shell" style="min-height:72vh;">
  <div class="hero-bg active" style="background-image:url('<?php echo e(e(\App\Support\TravelData::img('booking-hero'))); ?>');opacity:1"></div>
    ...
    <div class="row g-4 align-items-stretch">
      <div class="col-lg-5">
        <div class="full-hero-card reveal" style="min-height:100%; min-height:560px;">
          <div class="card-image" style="background-image:url('<?php echo e(e(\App\Support\TravelData::img('booking-side'))); ?>')"></div>
          <div class="content">
        ...
        <div class="form-shell reveal">
          <div class="d-flex flex-column flex-md-row justify-content-between gap-3 align-items-md-start mb-4">
            ...
            <div class="text-md-end">
              ...
              <strong><?php echo e(e($userName ?: $userEmail ?: 'Guest')); ?></strong>
            </div>
          </div>

          <form id="bookingForm" action="<?php echo e(route('booking.store')); ?>" method="post" class="row g-3">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="booking_type" value="<?php echo e(e($selectedType)); ?>">
            <input type="hidden" name="package_id" value="<?php echo e(e($selectedPackageId)); ?>">
            <input type="hidden" name="package_name" value="<?php echo e(e($displayPackageName)); ?>">
            <input type="hidden" name="country" value="<?php echo e(e($selectedCountry)); ?>">
            <input type="hidden" name="amount" value="<?php echo e(e($selectedAmount)); ?>">
            <input type="hidden" name="currency" value="USD">

            <div class="col-12"><div class="field-card"><label class="form-label">Trip / ticket</label><input type="text" class="form-control" name="package_name_display" value="<?php echo e(e($displayPackageName)); ?>" readonly><div class="field-hint">This is the trip or ticket name the admin will review.</div></div></div>
            ...
            <div class="col-md-6"><div class="field-card"><label class="form-label">Your name</label><input type="text" name="customer_name" class="form-control" value="<?php echo e(e($userName)); ?>" required></div></div>
            <div class="col-md-6"><div class="field-card"><label class="form-label">Email</label><input type="email" name="customer_email" class="form-control" value="<?php echo e(e($userEmail)); ?>" required></div></div>
            <div class="col-md-6"><div class="field-card"><label class="form-label">Phone</label><input type="text" name="customer_phone" class="form-control" required></div></div>
              ...
              <div class="p-3 rounded-4 bg-light border">
                <div class="d-flex flex-wrap justify-content-between gap-2 align-items-center">
                  ...
                  <div class="text-end">
                    ...
                    <strong><?php echo e(e($selectedAmount)); ?> USD</strong>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-12 d-flex flex-wrap gap-2">
              ...
              <a href="<?php echo e(route('packages')); ?>" class="btn btn-outline-dark px-4">Browse packages</a>
            </div>
          </form>
        </div>
      </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\faim\laravel-final-project\aurelia_laravel\resources\views/booking/create.blade.php ENDPATH**/ ?>