...
<section class="hero-shell" style="min-height:72vh;">
  <div class="hero-bg active" style="background-image:url('{{ e(\App\Support\TravelData::img('booking-hero')) }}');opacity:1"></div>
    ...
    <div class="row g-4 align-items-stretch">
      <div class="col-lg-5">
        <div class="full-hero-card reveal" style="min-height:100%; min-height:560px;">
          <div class="card-image" style="background-image:url('{{ e(\App\Support\TravelData::img('booking-side')) }}')"></div>
          <div class="content">
        ...
        <div class="form-shell reveal">
          <div class="d-flex flex-column flex-md-row justify-content-between gap-3 align-items-md-start mb-4">
            ...
            <div class="text-md-end">
              ...
              <strong>{{ e($userName ?: $userEmail ?: 'Guest') }}</strong>
            </div>
          </div>

          <form id="bookingForm" action="{{ route('booking.store') }}" method="post" class="row g-3">
            @csrf
            ...
            <div class="col-12 d-flex flex-wrap gap-2">
              ...
              <a href="{{ route('packages') }}" class="btn btn-outline-dark px-4">Browse packages</a>
            </div>
          </form>
        </div>
      </div>
