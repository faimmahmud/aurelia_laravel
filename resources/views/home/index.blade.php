    ...
    <div class="home-page">
        <section class="home-hero">
            <div class="container-fluid px-3 px-lg-4">
                <div class="home-hero__shell reveal" style="background-image:url('{{ asset('assets/desa.jpg') }}')">
        ...
        <section class="home-section home-section--luxury-destinations">
            <div class="container">
                <div class="luxury-section-head reveal">
                    ...
                    <a class="home-link" href="{{ route('destinations') }}">View all destinations <i
                            class="bi bi-arrow-right"></i></a>
                </div>

                <div class="luxury-destination-grid">
                    @foreach (array_slice($destinations, 0, 5) as $destination)
                        <article class="luxury-destination-card reveal"
                            data-search="{{ $destination['name'] . ' ' . $destination['country'] . ' ' . $destination['tag'] }}"
                            ...
                            <div class="luxury-destination-card__content">
                                <span class="luxury-destination-card__eyebrow">{{ $destination['tag'] }}</span>
                    ...
                    <aside class="luxury-offer-card reveal">
                        ...
                        <a class="btn btn-light rounded-pill px-4 fw-semibold luxury-offer-card__cta"
                            href="{{ route('packages') }}">Explore Deals <i class="bi bi-arrow-right ms-1"></i></a>
                    </aside>
                </div>
            </div>
        </section>
        ...
        <section class="home-section home-section--featured">
            <div class="container">
                <article class="featured-journey reveal" style="background-image:url('{{ asset('assets/world.jpg') }}')">
        ...
        <section class="home-section">
            <div class="container">
                <div class="d-flex align-items-end justify-content-between gap-3 mb-4 flex-wrap">
                    ...
                    <a class="home-link reveal" href="{{ route('packages') }}">View all packages <i
                            class="bi bi-arrow-right"></i></a>
                </div>

                <div class="experience-grid">
                    @foreach (array_slice($featuredTours, 0, 4) as $tour)
                        <article class="experience-card reveal"
                            data-search="{{ $tour['title'] . ' ' . $tour['category'] . ' ' . $tour['days'] }}">
                            <div class="experience-card__image" style="background-image:url('{{ $tour['image'] }}')">
                                <span class="experience-card__badge">{{ ucfirst($tour['category']) }}</span>
                            </div>
                            <div class="experience-card__content">
                                ...
                                <div class="experience-card__price">From {{ $tour['price'] }} /person</div>
                            </div>
                        </article>
                    @endforeach
                </div>
